...
export default makeTheme({
  colors: {
    ...
    'settings.checkboxBackground': darkTheme.background.default,
    'settings.checkboxBorder': darkTheme.border.secondary,
    'settings.dropdownBackground': darkTheme.background.default,
    'settings.dropdownBorder': darkTheme.border.secondary,
    'settings.numberInputBackground': darkTheme.background.default,
    'settings.numberInputBorder': darkTheme.border.secondary,
    'settings.textInputBackground': darkTheme.background.default,
