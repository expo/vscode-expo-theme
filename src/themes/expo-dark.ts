...
export default makeTheme({
  colors: {
    ...
    'editorWidget.background': darkTheme.background.subtle,
    ...
    'panel.border': darkTheme.background.default,
    ...
    'peekViewResult.lineForeground': darkTheme.icon.tertiary,
    'peekViewResult.matchHighlightBackground': palette.dark.blue8,
    ...
    'sideBar.border': darkTheme.background.default,
    ...
    'statusBar.background': darkTheme.button.primary.background,
